  ...
  <div>
    <v-row>
      ...
      <templateCard>
        ...
        <template v-slot:titulo>ALL IN ONE COMPAQ 23,8"</template>
      ...
      <templateCard>
        ...
        <template v-slot:titulo>ALL IN ONE POSITIVO 18,5"</template>
      ...
      <templateCard>
        ...
        <template v-slot:titulo>ALL IN ONE THINKCENTRE E73Z 18,5"</template>
